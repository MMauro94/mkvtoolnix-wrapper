 ...
 *
 * The [FAST] mode does not parse the whole file but uses the meta seek elements for locating the required elements of a source file. In 99% of all cases this is enough. But for files that do not contain meta seek elements or which are damaged the user might have to set the [FULL] parse mode. A full scan of a file can take a couple of minutes while a fast scan only takes seconds.
 *
